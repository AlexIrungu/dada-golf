        ...
        <div className="container mt-5">
            ...
            <div className="row mt-3">
                ...
                <div className="col-mt-6">
                    <p>
                    The primary goal will also be to give clear information on
                    conditions and concerns affecting women through
                    a forum of medical experts i.e Oncologists, Pediatricians,
                    Surgeons, Dentists, nurses, pharmacy professionals, Counsellors etc.
                    </p>
                    <ul>
                        <li>Breast cancer</li>
